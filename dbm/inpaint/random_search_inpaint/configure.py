...
for job_id in xrange(num_jobs):
    train_file_full_stem = 'exp/'+str(job_id)+'/sup_inpaint'
    ...
    learning_rate =  784 * 10. ** rng.uniform(-2.6, -.6)
    ...
    if rng.randint(2):
        ...
        act_reg = \
        """l1_act_targets: [  %(h0_target)f, %(h1_target)f, 0. ],
            l1_act_eps:     [  %(h0_eps)f,  %(h1_eps)f, 0. ],
            l1_act_coeffs:  [ %(h0_coeff)f, %(h1_coeff)f, 0.  ],""" % locals()
