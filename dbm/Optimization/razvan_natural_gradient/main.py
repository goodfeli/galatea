...
class MainLoop(object):
    ...
    def validate(self):
        ...
        self.batch_start_time = time.time()
        if self.k < self.valid_timing.shape[0]:
            self.valid_timing[self.k] = float(cost)
    ...
    def test(self):
        ...
        if self.k < self.test_timing.shape[0]:
            self.test_timing[self.k] = float(cost)
...
if __name__ == '__main__':
    ...
    options['data'] = '/data/lisatmp/pascanur/data/mnist.npz'
    options['verbose'] = 3
    options['device'] = 'gpu'
    ...
    options['type'] = 'Gf' # Gf
    options['adaptivedamp'] = 1.
    options['loopIters'] = 400
    options['gotNaN'] = 0
    options['seed'] = 123
    options['hids'] = '[400,200,30]'#'[1000, 500, 250, 30]'
    ...
    options['miters'] = numpy.int32(80)
    options['lr'] = 1.
    options['lsIters'] = 80
    options['checkFreq'] = 5
    options['krylovDim'] = 15
    options['lbfgsIters'] = 10
    
    options['krylovDim'] = 25
    options['lbfgsIters'] = 15
    """
