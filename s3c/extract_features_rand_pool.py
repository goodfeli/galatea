...
print 'loading pooling matrix...'
pooling_matrix = serial.load('/u/goodfeli/galatea/s3c/pooling_mat.pkl')
print '...done'
...
class FeatureExtractor:
    ...
    def _execute(self):
        ...
        num_superpixels = 7
        output =  np.zeros((num_examples,pooling_matrix.shape[0]),dtype='float32')
