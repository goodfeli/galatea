...
bow = serial.load('/data/lisatmp/goodfeli/esp_bow.pkl')
words = bow.words
del bow
import gc
gc.collect
import os
labels_dir = '/data/lisatmp/goodfeli/esp/data/labels'
labels = sorted(os.listdir(labels_dir))

assert len(labels) == 100000
...
l2_path = '/data/lisatmp/goodfeli/esp/l2'
import numpy as np

from pylearn2.utils import image

imbase = '/data/lisatmp/goodfeli/esp/data/originals'
