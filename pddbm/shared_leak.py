...
gc.collect()
gc.collect()
print 'references to initial array after deleting s: ',sys.getrefcount(init_array)
#del after_after
#del expected_diff
del grad
gc.collect()
gc.collect()
gc.collect()
print 'references to initial array after deleting grad: ',sys.getrefcount(init_array)
del searched_objs
gc.collect()
gc.collect()
gc.collect()
