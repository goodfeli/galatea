...
class ContrastiveSparseCoding:
    def __init__(self, nvis, nhid, contract_coeff,
            init_lambda,
            init_p, init_alpha, learning_rate, tol = 1e-6):
        self.nvis = int(nvis)
        self.nhid = int(nhid)
        self.contract_coeff = float(contract_coeff)
