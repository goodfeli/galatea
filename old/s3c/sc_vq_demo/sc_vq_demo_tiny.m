...
save('/u/goodfeli/adam_tiny_train.mat','trainXCs');

trainXCs = load('/u/goodfeli/adam_tiny_train.mat');
trainXCs = trainXCs.trainXCs;
...
save('/u/goodfeli/adam_tiny_test.mat', 'testXCs');

testXCs = load('/u/goodfeli/adam_tiny_test.mat');
testXCs = testXCs.testXCs;
