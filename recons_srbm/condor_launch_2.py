...
for i in xrange(num_jobs):
    ...
    if rng.uniform(0.,1.) > 0.5:
        ...
        beta = N.exp(rng.uniform(N.log(0.25),N.log(5)))
    else:
        learn_beta = 0
        beta_lr_scale = 1.
        beta = N.exp(rng.uniform(N.log(2),N.log(11)))

    mean_field_iters = rng.randint(5,12)
    no_damp_iters = rng.randint(0,3)
    ...
    if rng.uniform(0.,1.) > 0.2:
        ...
        persistent_chains = rng.randint(1,15)
...
!obj:framework.scripts.train.Train {
    "dataset": !pkl: &data "/data/lisatmp/goodfeli/cifar10_preprocessed_train.pkl",
