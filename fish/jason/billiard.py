...
class BilliardVideoConfig(object):
    '''This is just a container for specifications for a BilliardVideo
    ...
    def __init__(self, axes = ('b', 0, 1, 2, 'c'),
        ...
        # Arbitrary choice: we do the validation here, not in BilliardVideo
