...
mf1mod = serial.load('cifar10_model_3.pkl')
#mf1mod.hidden_layers[0].transformer._filters.name = 'W1'
#mf1mod.hidden_layers[1].transformer._filters.name = 'W2'
#mf1mod.hidden_layers[2].W.name = 'W3'
#mfnmod = make_super_dbm(mf_iter)
...
while True:
    ...
    serial.save('cifar10_model_3.pkl',mf1mod)
    if epoch % 10 ==0:
